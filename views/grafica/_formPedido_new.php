...
foreach ($model->detallesPedido as $d) {
    ...
    $detalles .= $sep . '{"id":' . $d->id . ',"productos_id":' . $d->productos_id . ',"producto":"' . $d->producto->nombre . '","cantidad":' . $d->cantidad . ',"ancho":' . $d->ancho .
        ',"alto":' . $d->alto . ',"fraccion":'.($d->fraccion?$d->fraccion:'0.00').',"inst":' . $d->inst . ',"detalle":"' . str_replace('"', "'", $d->detalle) . '","monto":' . $d->monto . ',"estado":"' . $estado . '"}';
    $sep = ',';
}
        ...
        <div class="col-md-12">
         ...
         <div class="row marcoItems" >
            ...
            <div class="form-group">
                ...
                <button class="btn btn-success" type="button" onclick="botEnviar(this,'grafica')" style="font-size:1.5em;">Aceptar</button>
