     ...
     function dibujarGraficas(){  
        ...
        function getReporte(codigo,...parameters){
            ...
            switch(codigo){
             ...
             (new Server).consulta('index.php?r=grafica/report-ajax&id='+idApp+'&data='+data,{'_csrf': yii.getCsrfToken()},function(result){     
                    console.log(result)
        ...
        function getMeses(){
            ...
            //getWeb('index.php?r=grafica/report-ajax&id='+idApp+'&data='+data).then((result)=>{
            (new Server).consulta('index.php?r=grafica/report-ajax&id='+idApp+'&data='+data,{'_csrf': yii.getCsrfToken()},function(result){
                    console.log(result)
                   // result=JSON.parse(result)
                    if(result.error===0){
