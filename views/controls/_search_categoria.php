...
?>
        ...
        <div class="row bg-primary" style="border-radius: 5px;padding: 5px;">
            ...
            <?php
                ...
                ?>
            <div class=col-md-3 style=" padding: 10px 5px; height: 65px;">
           
               <?= $form->field($model, 'categoriaCodigo')->dropDownList($categorias,  ['prompt'=>'-Todos-','onchange'=>"this.form.submit()"])->label('Categorias'); ?>
           
            </div>
            
            
            <div class="col-md-6" style=" padding: 3px 5px; height: 60px;">
