...
?>
        ...
        <div class="row bg-primary" style="border-radius: 5px;padding: 5px;">
            ...
            <div class="col-md-8" style=" padding: 3px 5px; height: 60px;">

                <?php
                $form = ActiveForm::begin([
                            'action' => [$action,'id'=>$model->app_idApp],
                            'method' => 'get',
                ...
                ?>
                    ...
                    <span   class="" style="position: absolute;right: 5px;">
                        <?= Html::a(' <img src="assets/icons/plus.svg" color:white; alt="" style=" width:64px;margin-top: -0.2em;margin-left: -0.4em;"><span>Agregar'.$label.'</span>' , [$actionCreate,'id'=>$model->app_idApp], ['class' => 'btn btn-success  mx-2 bot-add','style' => 'font-size:1.5em;']) ?>
                    </span>
