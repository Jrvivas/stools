...
$estados=['ESPERA'=>'Espera','DISENIO'=>'Diseño','ELABORACION'=>'Elaboración','RETRASADO'=>'Retrasado','TERMINADO'=>'Terminado','ENTREGADO'=>'Entregado','FINALIZADO'=>'Finalizado','ANULADO'=>'Anulado'];
   ...
   // var detalles=[];
    ...
    function calcularMonto(){
        ...
        if(productoSel.unidad=='M2'){
            ancho=$("#pedido-ancho").val()*1;
            alto=$("#pedido-alto").val()*1;
            inst=$("#pedido-instalar").val()*1;
        }
            ...
            server.consulta('index.php?r=pedido%2Fcreate-ajax&id='+idApp,{'_csrf': yii.getCsrfToken(),'data':newPedido},function(rst){
                    ...
                    if(rst){
                        ...
                        if(rst.error>0){
                            ...
                            window.locationf="distribuidora/pedidos&id="+idApp;
                        }
