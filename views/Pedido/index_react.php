...
//$this->registerJsFile(Yii::getAlias('@web') . '/js/models/app_model_pedido.js?v=0.002', ['type'=>'text/babel','position' => View::POS_END], null);
$this->registerJsFile(Yii::getAlias('@web') . '/js/models/app_model_pedido.js?v=0.002', ['position' => View::POS_END], null);
//$this->registerJsFile(Yii::getAlias('@web') . '/js/components/app_view_new_pedido.js?v=0.001', ['type'=>'text/babel','position' => View::POS_END], null);
...
//$this->registerJsFile(Yii::getAlias('@web') . '/js/components/app_view_pedido.js?v=0.003', ['type'=>'text/babel','position' => View::POS_END], null);//Agregamos React
